...
export class HomeComponent implements OnInit {
  ...
  news: any[] = [
    {
      ...
      image: '../../../assets/images/about-us/thumbnails/IELCKoramangala_HOC_Newsletter_August_2022.png',
      alt: 'News image',
    ...
    },
    {
      ...
      image: '../../../assets/images/about-us/thumbnails/uniq.png',
      alt: 'News image',
  ...
  onSubmit() {
    if (this.funClassSubmissionForm.valid) {
      this.isLoading = true;
      this.homeService.apiHomeEnquiryFormPost(5, this.funClassSubmissionForm.value)
        .subscribe((data) => {
