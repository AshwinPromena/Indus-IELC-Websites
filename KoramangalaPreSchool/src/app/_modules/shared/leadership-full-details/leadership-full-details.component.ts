  ...
  leadershipList = [
    {
      ...
      description: [
        ...
        "She is a certified Image consultant and qualified soft skills trainer from the Image Consultant Business Institute, Bangalore. She has also had the unique opportunity to travel and align herself with different leadership positions and systems of education across the country.",
        "She believes in the philosophy that all children can learn. She first joined Indus as a leadership and life skills coach at Indus Training and Research Institute and the Indus Community School, and was the founder teacher for Indus Early Learning Centre Koramangala, Bangalore. Being a critically reflective practitioner, she regularly updates her portfolio with IB workshops and deep reading courses to keep abreast of latest developments in her field.",
