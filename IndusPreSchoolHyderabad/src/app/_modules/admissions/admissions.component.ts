...
export class AdmissionsComponent implements OnInit {
  ...
  readMore(id) {
    console.log(id);
    this._dialog.open(AdmissionTestimonialsComponent, {
      data: id
    });
