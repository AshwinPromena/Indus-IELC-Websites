...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([{
      ...
      data: {
        title: 'Beyond Academics | Day Care | Schools In  Jubilee Hills ',
        description: 'We are one of few school which provide academic programme in Jubilee Hills as well as extra curriculum activities like arts, music, dance, drama & sports.'
      }
    }]),
    AppThemeModule,
  ]
