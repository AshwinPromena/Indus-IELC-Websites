...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([{
      ...
      data: {
        title: 'Beyond Academics | Day Care | Schools In Whitefield  ',
        description: 'We are one of few school which provide academic programme in Whitefield  as well as extra curriculum activities like arts, music, dance, drama & sports.'
      }
    }]),
    AppThemeModule,
  ]
