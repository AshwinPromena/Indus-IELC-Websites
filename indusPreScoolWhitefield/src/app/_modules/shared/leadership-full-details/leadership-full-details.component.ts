...
export class LeadershipFullDetailsComponent implements OnInit {
  leadershipList = [
    {
      id:1,
      image: "../../../assets/images/about-us/leadership/HOC.jpg",
      title: "Head of Centre",
      name: "Ms. Priyanka Khurana.",
      description: [
        "Ms. Priyanka Khurana has 15+ years of experience as an educator and in depth knowledge of American curriculum and IB curriculum. Ms. Priyanka comes with Master in Business and Teaching degree from Southern Methodist University, Dallas, United States. She is deeply passionate a creating a culture of learning that deepens student engagement and brings in diverse perspectives.",
        "Philosophy of education centers on a collaborative approach with stakeholders including parents, teachers, and students as partners, and espouses student learning through exploration. Skilled in Curriculum Development, Teacher Training, Mentoring, and Educational Technology. Her core strengths are interpersonal skills, enhanced knowledge of IB PYP and people management. Ms. Priyanka believes the happiness quotient is a strong measure of an effective school and is always working to achieve that goal.",

      ]
    },
    {
      id:2,
      image: "../../../assets/images/about-us/leadership/Sarojini_Rao.jpg",
