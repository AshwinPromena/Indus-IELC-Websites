  ...
  leadershipList = [
    {
      ...
      description: [
        "Sonali Malhotra has had a dual career under the umbrella of Early childhood education and Leadership training & consultancy spanning two decades. She is a Liberal arts graduate from Delhi University.",
        "She also holds a Post-graduate Diploma in Education (International) from Birmingham City University UK and has additionally secured her Cambridge International Diploma in Teaching and Learning with a distinction from The Teacher Foundation. Her experience with play-based learning is vast and her visit to schools in Finland strengthened this holistic pedagogical practice.",
        "She is a certified Image consultant and qualified soft skills trainer from the Image Consultant Business Institute, Hyderabad. She has also had the unique opportunity to travel and align herself with different leadership positions and systems of education across the country.",
        "She believes in the philosophy that all children can learn. She first joined Indus as a leadership and life skills coach at Indus Training and Research Institute and the Indus Community School, and was the founder teacher for Indus Early Learning Centre Jubilee Hills, Hyderabad. Being a critically reflective practitioner, she regularly updates her portfolio with IB workshops and deep reading courses to keep abreast of latest developments in her field.",
        "Head of Centre Sonali Malhotra maintains that true collaboration and partnership between students, parents and school is the best way to unlock a child’s potential. That being said it is equally crucial to be a lifelong learner, be open to the power of feedback and strive for excellence. "
      ]
    },
    {
      id:2,
      ...
      description: [
        "Mrs. Sarojini Rao, Principal of Indus International School, Hyderabad since July 2005, has exceptional academic credentials. She ranked first at the University of Pune in B.A Economics and holds three postgraduate degrees – Economics, Education and Business Administration from the University of Edinburgh.",
        ...
        "She is the Managing Trustee of Indus International Community School, Hyderabad, one of India’s best international schools that offer quality education to the underprivileged.",
